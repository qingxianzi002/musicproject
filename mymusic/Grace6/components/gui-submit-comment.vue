	...
	:zIndex="zIndex">
		...
		@tap.stop.prevent="stopfun">
			<view class="gui-flex gui-row gui-space-between gui-align-items-center">
				...
				hover-class="gui-tap">
					<text 
					class="gui-comments-btns gui-block gui-comments-submit gui-icons gui-primary-color" 
					@tap="submit">提交</text>
				</view>
			</view>
			<view 
			class="gui-flex gui-row gui-nowrap gui-space-between" 
			style="padding-bottom:26rpx;">
				<view 
				...
				:placeholder="comment.at == '' ? placeholder : '@'+comment.at" />
			</view>
			<view>
