				...
				hover-class="gui-tap">
					...
					:datas="[index]">
						<view class="gui-flex gui-row gui-nowrap gui-space-between">
							...
							<text 
							class="gui-slide-list-desc gui-block gui-color-gray ps-space gui-flex-shrink0">{{item.time}}</text>
						</view>
						<text 
						:class="[descEllipsis?'gui-ellipsis':'']" 
						class="gui-slide-list-desc gui-third-text gui-block">{{item.content}}</text>
					</gui-touch>
				</view>
				<view 
